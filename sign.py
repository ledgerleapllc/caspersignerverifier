...
try:
	...
	print("")
	print("You may need to use sudo depending on your system permissions.")
	sys.exit(1)
...
class CasperSigner(Ed25519):
	...
	def show_help(self):
		...
		print("")
		print("This Signer Script takes 2 arguments:")
		...
		print("   it is a CasperLabs type SECP256K1 public key. In this case, use the -s flag.")
		print("   This script will automatically find and verify your public key hex if not specified.")
		print("")
		print("Example usage:")
		print("")
		print("  python3 sign.py  message.txt")
		print("  sudo python3 sign.py  ~/Downloads/message.txt  /etc/casper/validator_keys/secret_key.pem")
		print("")
		print("Note:")
